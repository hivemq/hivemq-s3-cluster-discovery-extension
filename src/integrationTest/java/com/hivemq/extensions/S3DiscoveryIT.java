...
class S3DiscoveryIT {
    ...
    void cluster_singleNode() throws IOException {
        ...
        assertEquals(1, metrics.get(IP_COUNT_METRIC));
    }
    ...
    void cluster_twoNode() throws IOException {
        ...
        assertEquals(1, secondNodeMetrics.get(SUCCESS_METRIC));
        assertEquals(0, secondNodeMetrics.get(FAILURE_METRIC));
        assertEquals(2, secondNodeMetrics.get(IP_COUNT_METRIC));
    }
