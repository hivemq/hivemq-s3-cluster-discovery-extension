...
Use the credentials specified in the `conf/config.properties` file to authenticate.
...
Use the credentials specified in `conf/config.properties` file to authenticate with a temporary session.
