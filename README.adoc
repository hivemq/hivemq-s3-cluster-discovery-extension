...
----
com.hivemq.extensions.s3-cluster-discovery.query.success.count
com.hivemq.extensions.s3-cluster-discovery.query.failed.count
----

This gauge shows the number of currently found cluster member IP addresses that were received during the last S3 query:

----
com.hivemq.extensions.s3-cluster-discovery.resolved-addresses
----
